...
// Methods
////////////////////////////////////////////////////////////////////////////////
void WZAnalysis::define_histograms()
{
  // HISTOGRAMS
  // Global histograms
...
////////////////////////////////////////////////////////////////////////////////
void WZAnalysis::FillOutputList()
{
  // histograms
...
////////////////////////////////////////////////////////////////////////////////
void WZAnalysis::WriteHistograms()
{
  // histograms
...
void WZAnalysis::FillHistogramsGlobal( double m, float w , TString s)
{
  ...
  //if (s.Contains("hist_Zmass")) hist_Topmass->Fill(m,w);
...
void WZAnalysis::FillHistogramsLeadlept( double m, float w , TString s)
{
  //Leading lepton histograms
  ...
  if (s.Contains("hist_leadleptch2")) hist_leadleptch->Fill(m,w);

  if (s.Contains("hist_leadleptID2")) hist_leadleptID->Fill(m,w);

  if (s.Contains("hist_leadlept_ptc2")) hist_leadlept_ptc->Fill(m,w);

  if (s.Contains("hist_leadleptetc2")) hist_leadleptetc->Fill(m,w);

  if (s.Contains("hist_leadlepz02")) hist_leadlepz0->Fill(m,w);

  if (s.Contains("hist_leadlepd02")) hist_leadlepd0->Fill(m,w);
}


void WZAnalysis::FillHistogramsLeadJet( double m, float w , TString s)
{
